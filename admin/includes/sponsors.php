...
function deleteSelected(id)
{
    ...
    {
        alert('Please select at least one sponsor to delete');
        return false;
    }

    if( confirm('Are you sure you want to delete ' + (selected.length > 1 ? 'the selected sponsors?' : 'this sponsor?')) )
    {
        infoBarAjax({data: 'r=txSponsorDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=txShSponsorAdd" class="window {title: 'Add Sponsor'}">
        <img src="images/add.png" border="0" alt="Add Sponsor" title="Add Sponsor"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="txSponsorSearch">
    <input type="hidden" name="page" id="page" value="1">
    </form>

    <div style="padding: 0px 2px 5px 2px;">
      <div style="float: left; display: none;" id="_matches_">Sponsors <b id="_start_">?</b> - <b id="_end_">?</b> of <b id="_total_">?</b></div>
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="5" class="last warn">
            No sponsors matched your search criteria
          </td>
        </tr>
