...
<div class="alert centered">
  There must be at least one category defined before you can add galleries
</div>
...
<div style="padding: 10px;">
    <div class="margin-bottom">
      <div style="float: right;">
        <a href="docs/galleries.html#add" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      <?php if( $editing ): ?>
      Update this gallery by making changes to the information below
      <?php else: ?>
      Add a new gallery by filling out the information below
      <?php endif; ?>
    </div>
    ...
    <form action="index.php" method="POST" id="form">
      <fieldset>
        ...
        <div class="fieldgroup">
            ...
            <span id="charcount" style="padding-left: 5px;">0</span>
        </div>
        ...
        <div class="fieldgroup">
            ...
            <div style="padding: 3px 0px 0px 0px; margin: 0;">-</div>
            <?php else: ?>
        ...
        <div class="fieldgroup">
            ...
            <input type="text" name="date_scheduled" id="date_scheduled" size="20" value="<?php echo $_REQUEST['date_scheduled']; ?>" class="calendarSelectDate" />
        </div>

        <div class="fieldgroup">
            <label for="date_displayed">Displayed Date:</label>
            <input type="text" name="date_displayed" id="date_displayed" size="20" value="<?php echo $_REQUEST['date_displayed']; ?>" class="calendarSelectDate" />
        </div>

        <div class="fieldgroup">
            <label for="date_deletion">Delete Date:</label>
            <input type="text" name="date_deletion" id="date_deletion" size="20" value="<?php echo $_REQUEST['date_deletion']; ?>" class="calendarSelectDate" />
        </div>
      ...
      <button type="submit"><?php echo ($editing ? 'Update' : 'Add'); ?> Gallery</button>
    </div>

    <input type="hidden" name="r" value="<?php echo ($editing ? 'txGalleryEdit' : 'txGalleryAdd'); ?>">
