...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=txGalleryFieldDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    ...
    <div class="heading margin-bottom">
      <div class="heading-icon">
        <a href="index.php?r=txShGalleryFieldAdd" class="window {title: 'Add Gallery Field'}"><img src="images/add.png" border="0" alt="Add Gallery Field" title="Add Gallery Field"></a>
        &nbsp;
        <a href="docs/gallery-fields.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      User Defined Gallery Fields
    </div>
    ...
    <input type="hidden" name="r" value="txGalleryFieldSearch">
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="7" class="last warn">
            No user defined gallery fields match your search criteria
          </td>
        </tr>
