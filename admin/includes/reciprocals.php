  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=txShReciprocalAdd" class="window {title: 'Add Reciprocal Link'}"><img src="images/add.png" border="0" alt="Add Link" title="Add Link"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="txReciprocalSearch">
