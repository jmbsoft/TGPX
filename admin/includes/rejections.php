...
function deleteSelected(id)
{
    ...
    {
        alert('Please select at least one rejection e-mail to delete');
        return false;
    }

    if( confirm('Are you sure you want to delete ' + (selected.length > 1 ? 'the selected rejection e-mails?' : 'this rejection e-mail?')) )
    {
        infoBarAjax({data: 'r=txRejectionTemplateDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=txShRejectionTemplateAdd" class="window {title: 'Add Rejection E-mail'}"><img src="images/add.png" border="0" alt="Add Rejection" title="Add Rejection"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="txRejectionTemplateSearch">
    <input type="hidden" name="page" id="page" value="1">
    </form>

    <div style="padding: 0px 2px 5px 2px;">
      <div style="float: left; display: none;" id="_matches_">E-mails <b id="_start_">?</b> - <b id="_end_">?</b> of <b id="_total_">?</b></div>
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="5" class="last warn">
            No rejection e-mails matched your search criteria
          </td>
        </tr>
