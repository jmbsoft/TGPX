...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=txBlacklistDelete&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=txShBlacklistAdd" class="window {title: 'Add Blacklist Item'}"><img src="images/add.png" border="0" alt="Add Item" title="Add Item"></a>
        &nbsp;
        <a href="index.php?r=txShRegexTest" class="window {title: 'Test Regular Expressions'}"><img src="images/re-test.png" border="0" alt="Test Regex" title="Test Regex"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="txBlacklistSearch">
